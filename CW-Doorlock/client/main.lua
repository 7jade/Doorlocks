...
AddEventHandler('esx:playerLoaded', function()
 Citizen.SetTimeout(1000, function()
	TriggerEvent('esx:getSharedObject', function(obj) ESX = obj end)
	 Citizen.Wait(250)
	 ESX.TriggerServerCallback("CW-Doorlock:server:get:config", function(config)
		Config = config
	end)
	Citizen.Wait(150)
	LoggedIn = true
...
RegisterNetEvent('CW-Doorlock:client:change:door:looks')
AddEventHandler('CW-Doorlock:client:change:door:looks', function(Door, Type)
...
RegisterNetEvent('CW-Doorlock:server:reset:door:looks')
...
RegisterNetEvent('CW-Doorlock:client:setState')
AddEventHandler('CW-Doorlock:client:setState', function(Door, state)
...
function SetDoorLock(Door, key)
 ...
 SetTimeout(1000, function()
   ...
   TriggerServerEvent('CW-Doorlock:server:updateState', key, Door['Locked'])
 end)
end
...
function ChangeDoorLooks(Door, Type)
	TriggerServerEvent('CW-Doorlock:server:change:door:looks', Door, Type)
end